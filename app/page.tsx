...
interface SearchParamsProps {
  manufacturer?: string;  // Manufacturer name (e.g., "Audi")
  model?: string;         // Model name (e.g., "Q5")
  year?: number; // Year (can be a number or string, default is 2023)
  fuel?: string;          // Fuel type (e.g., "gas", "electric")
  limit?: number ; // Limit on the number of results (default is 10)
}
